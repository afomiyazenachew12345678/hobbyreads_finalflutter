  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      if (errorMessage.contains('already reviewed')) {
        _showErrorDialog('You have already reviewed this book. You can find your review below and edit or delete it if needed.');
      } else {
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            if (user != null && !_showReviewForm && !_hasUserReviewed(reviewsState.reviews, user.id))
                              TextButton.icon(
                                onPressed: () {
                                  setState(() {
                            ...
                            if (user != null && _hasUserReviewed(reviewsState.reviews, user.id))
                              Container(
                        ...
                        if (reviewsState.isLoading)
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                TextButton(
                                  onPressed: () {
                                    ref.read(reviewsProvider(widget.bookId).notifier).loadReviews();
                                  },
                          ...
                          Column(
                            children: reviewsState.reviews.map((review) => 
                              Padding(
                                ...
                                child: _ReviewItem(
                                  ...
                                  onDelete: (reviewId) {
                                    ref.read(reviewsProvider(widget.bookId).notifier).deleteReview(reviewId);
                                  },
                                ),
                              )
                            ).toList(),
...
class _ReviewItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isCurrentUser = currentUserId != null && review.userId != null && 
